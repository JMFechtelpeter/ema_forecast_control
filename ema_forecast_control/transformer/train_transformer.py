...
from ema_forecast_control.transformer.transformer_training_algorithm import TransformerTrainer

tc.set_num_threads(1)

def get_parser():
    parser = argparse.ArgumentParser(description="ema_forecast_control Transformer Training")
...
def train_transformer(args: dict) -> str:
    ...
    training_algorithm = TransformerTrainer(args, dataset, test_data, test_inputs, save_path, device)
